...
<head>
<title>S&uuml;ndenrechner | Deine S&uuml;nden bitte!</title>
...
myval++;
document.frm.cnt.value = myval;
if(document.getElementById(name).style.display=="none"){
//document.getElementById(name).style.display = "block";

  Effect.SlideDown(document.getElementById(name), {duration:0.2});
  new Effect.Highlight(document.getElementById(name), {startcolor:'#FF9999', endcolor:'#FFFFFF'});
}
else Effect.SlideUp(document.getElementById(name), {duration:0.2});
}
</script>
...
<link rel=stylesheet type="text/css" href="./inc/style.css">
 ...
 <div align="center">
 <form name="frm" action="end.php" method="post">
<table id="tra">
 <tr>
  <td>

<h3>Pecados grandes a precios regulares</h3><input onClick="showDiv('off1')" type="checkbox" name="id[1]" value="1" /> 
He tomado drogas <br />

<div id="off1" style="display:none;"><input onClick="showDiv('off2')" type="checkbox" name="id[2]" value="2" />  ... y esto mas que una vez </div><br>
<input onClick="showDiv('off3')" type="checkbox" name="id[3]" value="3" /> 
He ofrecido drogas a alguien <br />
<input onClick="showDiv('off4')" type="checkbox" name="id[4]" value="4" /> 
He traficado drogas <br />
<br>
<input onClick="showDiv('off5')" type="checkbox" name="id[5]" value="5" /> 
A veces muestro el dedo del culo cuando estoy conduciendo <br />
<input onClick="showDiv('off6')" type="checkbox" name="id[6]" value="6" /> 
He causado un accidente <br />
<input onClick="showDiv('off7')" type="checkbox" name="id[7]" value="7" /> 
He golpeado otro coche cuando intentaba aparcar <br />

<div id="off7" style="display:none;"><input onClick="showDiv('off8')" type="checkbox" name="id[8]" value="8" />  ... y me he dado la fuga </div>
<input onClick="showDiv('off9')" type="checkbox" name="id[9]" value="9" /> 
He conducido ciegisimo <br /><br>
<input onClick="showDiv('off10')" type="checkbox" name="id[10]" value="10" /> 
A veces invento mentiras <br />
<input onClick="showDiv('off11')" type="checkbox" name="id[11]" value="11" /> 
Causo rumores <br />
<input onClick="showDiv('off12')" type="checkbox" name="id[12]" value="12" /> 
Hago acosos morales bastantes fuertes<br />

<input onClick="showDiv('off13')" type="checkbox" name="id[13]" value="13" /> 
A veces estoy despejellando sobre la fisica de los démas<br /><br>
<input onClick="showDiv('off14')" type="checkbox" name="id[14]" value="14" /> 
Me he despertado sin conocer la otra persona dormiendo en la misma cama  <br />
<input onClick="showDiv('off15')" type="checkbox" name="id[15]" value="15" /> 
He pagado por sexo <br />
<input onClick="showDiv('off16')" type="checkbox" name="id[16]" value="16" /> 
He cobrado por sexo <br />
<input onClick="showDiv('off17')" type="checkbox" name="id[17]" value="17" /> 
He tenido sexo en la cama de mis padres  <br /><br>

<input onClick="showDiv('off18')" type="checkbox" name="id[18]" value="18" /> 
He pegado alguien hasta tenia que irse al hospital <br />
<input onClick="showDiv('off19')" type="checkbox" name="id[19]" value="19" /> 
He robado bragas de la linea de otra gente <br />
<input onClick="showDiv('off20')" type="checkbox" name="id[20]" value="20" /> 
En momentos de descuido estoy miranod los cajones y armarios de otra gente <br /><br>
<input onClick="showDiv('off21')" type="checkbox" name="id[21]" value="21" /> 
He robado algo que vale mas que 100€ <br />
<input onClick="showDiv('off22')" type="checkbox" name="id[22]" value="22" /> 
He robado a mis padres  <br />

<input onClick="showDiv('off23')" type="checkbox" name="id[23]" value="23" /> 
He robado a mi pareja <br />
<input onClick="showDiv('off24')" type="checkbox" name="id[24]" value="24" /> 
He destruido algo solo por vandalismo <br />
<input onClick="showDiv('off25')" type="checkbox" name="id[25]" value="25" /> 
He pintado grafitis <br />
<input onClick="showDiv('off26')" type="checkbox" name="id[26]" value="26" />
No hago reciclaje
<br /><br>
<input onClick="showDiv('off27')" type="checkbox" name="id[27]" value="27" /> 
He chupado a alguien/me ha chupado alguien conduciendo <br />

<input onClick="showDiv('off28')" type="checkbox" name="id[28]" value="28" /> 
He tenido sexo en la iglesia  <br />
<input onClick="showDiv('off29')" type="checkbox" name="id[29]" value="29" />
He tenido sexo cuando habia otra gente en la misma habitacion <br />
<input onClick="showDiv('off30')" type="checkbox" name="id[30]" value="30" /> 
He tenido un trio  <br /><br>
<input onClick="showDiv('off31')" type="checkbox" name="id[31]" value="31" /> 
He tenido sexo con alguien que tiene mas que 10 anyos mas que yo <br />
<input onClick="showDiv('off32')" type="checkbox" name="id[32]" value="32" /> 
He tenido sexo con alguien que tiene mas que 10 anyos menos que yo <br />

<input onClick="showDiv('off33')" type="checkbox" name="id[33]" value="33" /> 
He puesto los cuernos a alguien  <br />
<input onClick="showDiv('off34')" type="checkbox" name="id[34]" value="34" /> 
He tenido sexo al telefono o en el chat <br />
<input onClick="showDiv('off35')" type="checkbox" name="id[35]" value="35" /> 
He dicho a alguien que sea bueno en la cama sinque era la verdad  <br /><br>
